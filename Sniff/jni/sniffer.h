...
struct global_stats { /*Structure to hold per pair statistics*/
    uint32_t num_tx;
    uint32_t tx_session;
    uint32_t num_rx;
    uint32_t rx_session;
...
/* Structure to hold global broadcast statistics */
